...
foreach ($needle in @("prefers-reduced-motion", "@media", "--cyan", "--amber", "atmosphereDrift", "avatarFloat", "lineTravel", "kinetic-title", "orbital-avatar", "cursor-light", "reveal.is-visible", "clip-path", "hero-embodied-ai-lab.webp")) {
...
foreach ($needle in @("鹿屿の博客", "https://luyvzz.github.io/", "GitHub Pages", "具身智能", "gpt-image-2", "micu-gpt-image-2", "去框化高级界面", "磁吸交互", "本地验证")) {
